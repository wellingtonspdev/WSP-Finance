...
export function TransactionModal({ isOpen, onClose }: TransactionModalProps) {
    ...
    return (
        <>
            ...
            <div className="fixed inset-x-0 bottom-0 md:inset-y-0 md:right-0 md:left-auto md:w-[500px] z-50 flex flex-col h-[92%] md:h-full bg-[#11051f]/85 backdrop-blur-xl border-t md:border-t-0 md:border-l border-white/10 rounded-t-[32px] md:rounded-l-[32px] md:rounded-tr-none shadow-2xl animate-[slideUp_0.3s_ease-out] md:animate-[slideLeft_0.3s_ease-out]">
